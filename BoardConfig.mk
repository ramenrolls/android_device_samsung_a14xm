...
# VINTF
DEVICE_MANIFEST_FILE += $(DEVICE_PATH)/conf/vintf/manifest.xml
DEVICE_MATRIX_FILE := $(DEVICE_PATH)/conf/vintf/compatibility_matrix.xml
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := $(DEVICE_PATH)/conf/vintf/framework_compatibility_matrix.xml
